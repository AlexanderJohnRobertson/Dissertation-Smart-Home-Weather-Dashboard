...
conn.execute('CREATE TABLE temperature(username varchar(40) primary key not null, password varchar(40) not null, forename varchar(40) not null, surname varchar(40) not null, email varchar(50) not null, phone varchar(20) not null, userType varchar(20) not null)')
